...
import { Users, Calendar, Clock, Check, ChevronRight } from 'lucide-react'
...
export default function ParentBookPage() {
  ...
  const handleSubmit = async () => {
    if (!selectedChild || !selectedCoach || !selectedSubject || !selectedDate || !selectedTime || !selectedEndTime) {
      alert('请填写完整预约信息')
      return
    }
          ...
          <CardContent className="space-y-4">
            ...
            {selectedCoach && (
              <Button
                ...
                disabled={!selectedSubject || !selectedDate || !selectedTime || !selectedEndTime || coachConflict}
              >
                提交预约
              </Button>
            )}
